      ...
      <section className="mx-auto w-full max-w-3xl">
        ...
        {!user ? (
          <div className="rounded-xl border border-white/10 bg-white/[0.035] p-5 md:p-7">
            ...
            <p className="mb-5 max-w-lg text-sm text-white/50">{mode === "register" ? "Choose a name and a passcode you will remember. Your login is ready immediately." : "Use the name and passcode you created for this upload portal."}</p>
